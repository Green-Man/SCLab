...
% Funnction [Y] = diff_solver(p0, dt, T, p_fun, method) calculate output of the specific 
...
%                 Runge-Kutta method.
% 
% Definition of I/O used in the function:
% 
%                 p0 - initail value p(0),
%                 dt - time step of the approximation,
%                 T - time of the approximation,
%                 p_fun - function p'(t) given as p_fun = @(p)(f(p)),
